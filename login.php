...
?>
    <form class="form" method="post" name="login" enctype="multipart/form-data">
        ...
        <center><a href="forgotpassword.php" style="color:green;">Forgot Password?</a>
        <span>&nbsp; &nbsp; &nbsp; &nbsp;<a href="adminlogin.php" style="color:green;">Admin Login</a></span>
    </center>
